...
export default function CompraForm() {
  ...
  async function handleSave(estado: "borrador" | "registrada") {
        ...
        <div>
          <div className="card sticky top-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-blue-800 text-xs mb-4">
              ...
              <p>Al <strong>Registrar</strong> la compra, el stock se actualiza y el asiento contable se genera.</p>
            </div>
            <div className="space-y-3">
              <button disabled={saving} onClick={() => handleSave("registrada")}
                className="btn-primary w-full flex items-center justify-center gap-2">
                {saving ? <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : <><Save className="w-4 h-4" />Registrar compra</>}
              </button>
