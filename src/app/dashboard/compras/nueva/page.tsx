...
export default function NuevaCompraPage() {
  ...
  // Código de retención IR ("" = sin retención). Al cambiar el proveedor se
  // preselecciona 22 (2% general) para personas naturales.
  ...
  // ── Búsqueda / creación de proveedor al vuelo ──────────────────
